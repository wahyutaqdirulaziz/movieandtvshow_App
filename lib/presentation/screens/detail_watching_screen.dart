...
class DetailScreenWatchingPage extends StatefulWidget {
  int? id;
  DetailScreenWatchingPage({super.key, required this.id});

  @override
  State<DetailScreenWatchingPage> createState() =>
      _DetailScreenWatchingPageState();
}

class _DetailScreenWatchingPageState extends State<DetailScreenWatchingPage> {
  Movie? movie;
  @override
                    ...
                    builder: (context, state) {
                      return Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            context.read<MoviewwatchlistBloc>().add(
                                MovieWatchEvent(
                                    isDeleted: true, id: widget.id));
                            Navigator.pop(context);
                            context
                                .read<MoviewwatchlistBloc>()
                                .add(MovieWatchEvent(isDeleted: false));
                          },
                          child: Text(
                            'Delete',
